    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "category": {
                    "type": "string",
                    "description": "Стандартная категория расхода. Выбери наиболее подходящую из: Еда и продукты, Рестораны и кафе, Развлечения, Коммунальные услуги, Оплата жилья, Транспорт, Одежда, Здоровье, Закупка товара, Аренда помещения, Реклама, Зарплата сотрудников, Прочее. Хачапури/кофе/обед → 'Рестораны и кафе'. Продукты в магазине → 'Еда и продукты'. Не пиши конкретное название блюда или товара."
                }
            },
