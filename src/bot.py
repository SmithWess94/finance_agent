...
TOOLS = [
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "description": {"type": "string", "description": "Стандартная категория дохода. Выбери из: Розничные продажи, Оптовые продажи, Доставка, Онлайн-продажи, Прочее. Не пиши конкретные детали заказа."}
            },
    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "category": {
                    "type": "string",
                    "description": "Стандартная категория расхода. Выбери наиболее подходящую из: Еда и продукты, Рестораны и кафе, Развлечения, Коммунальные услуги, Оплата жилья, Аренда жилья, Транспорт, Одежда, Здоровье, Учеба, Закупка товара, Аренда помещения, Реклама, Зарплата сотрудников, Новая почта, Прочее. Хачапури/кофе/обед → 'Рестораны и кафе'. Продукты в магазине → 'Еда и продукты'. Курсы/книги/обучение → 'Учеба'. Квартира/съём → 'Аренда жилья'. Доставка через Новую почту → 'Новая почта'. Не пиши конкретное название блюда или товара."
                }
            },
